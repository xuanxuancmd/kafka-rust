...
/// SourceTaskContext trait for source task context.
///
/// This corresponds to `org.apache.kafka.connect.source.SourceTaskContext` in Java.
pub trait SourceTaskContext {
    /// Returns the offset storage reader.
